Pod::Spec.new do |s|
  ...
  s.homepage      = 'http://tumblr.github.com/TMCache/'
  s.summary       = 'Fast parallel object cache for iOS and OS X.'
  s.authors       = { 'Justin Ouellette' => 'jstn@tumblr.com' }
  s.source        = { :git => 'https://github.com/tumblr/TMCache', :tag => "#{s.version}" }
  ...
  s.documentation = {
    :html => 'http://tumblr.github.com/TMCache/docs/html',
    :appledoc => [
      ...
      '--docset-fallback-url', 'http://tumblr.github.com/TMCache/docs/html/',
      '--ignore', 'example',
      '--ignore', 'docs',
      '--ignore', '*.m',
      '--no-repeat-first-par',
